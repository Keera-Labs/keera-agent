...
// project list (projects) and the create/move/update/delete handlers used by
...
export default function useProjects() {
    const { projects, refreshData, agentHook, agentSessions, agentContainerRefs } = useAppLayout()

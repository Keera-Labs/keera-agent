...
router.get("/api/projects/{project_id}/default-agent", agent_default_controller.get_default)
router.post("/api/projects/{project_id}/default-agent", agent_default_controller.set_default)
